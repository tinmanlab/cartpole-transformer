...
.stage-head{display:grid;grid-template-columns:22px 1fr;column-gap:7px;align-items:center;margin-bottom:9px;text-align:left}.stage-head>b{grid-row:1/3;width:22px;height:22px;line-height:22px;border-radius:50%;background:#293548;color:#fff;font-size:10px;text-align:center}.stage-head>span{font-size:12px;font-weight:700;color:#4b5563}.stage-head>small{font-size:9px;color:#9299a5}
.token-column{display:flex;flex-direction:column;gap:3px}.token-row,.qkv-row{height:32px;display:flex;align-items:center;justify-content:center;gap:5px;border-radius:6px;padding:2px 4px}.token-row.selected,.qkv-row.selected{background:#f1eefb}.time-label{width:23px;text-align:right;font:9px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7b8492}.dim-label{font-size:8px;color:#a0a6b0}.vector{position:relative;width:22px;height:28px;border:1px solid #e0e3e8;border-radius:4px;overflow:hidden;background:white}.qkv-bundle{height:28px;display:grid;grid-template-columns:repeat(3,19px);gap:3px}.vector.mini{width:19px;height:28px}.qkv-labels{display:grid;grid-template-columns:repeat(3,19px);gap:3px;justify-content:center;margin:0 0 5px 27px;font-size:9px;font-weight:700}.q{color:#3971e8}.k{color:#d95757}.v{color:#34966a}
.attention-core{display:grid;grid-template-columns:auto 44px;gap:9px;align-items:center;justify-content:center}.overview-matrix{display:flex;justify-content:center;padding:9px;border:1px solid #e5e7eb;background:#fbfbfd;border-radius:9px}.attention-mix{display:grid;grid-template-columns:9px 23px 9px 25px;gap:4px;align-items:center;font-size:11px;color:#7b8492}.attention-vector{width:23px;height:58px}.context-vector{outline:2px solid #ded7f2}.attention-read{display:flex;justify-content:center;align-items:center;gap:7px;margin-top:8px;font-size:9px;color:#7b8492}.attention-read strong{color:#7359b7;font-size:11px}
.block-live{display:flex;align-items:center;justify-content:center;gap:5px;flex-wrap:wrap}.block-live>span{font-size:10px;color:#8270b0}.block-op{padding:5px 6px;border:1px solid #e3e6eb;border-radius:5px;background:#fafbfc;font-size:8px;color:#667085}.hidden-vector{height:72px;width:23px}.block-overview>code{display:block;margin-top:7px;font:8px ui-monospace,SFMono-Regular,Menlo,monospace;color:#697386}
.force-visual{font-size:48px;color:#8b5cf6;line-height:.85}.force-value{display:block;font:12px ui-monospace,SFMono-Regular,Menlo,monospace;color:#6d52aa;margin-top:8px}.action-overview>small{font-size:9px;color:#9299a5}
@media(max-width:1220px){.overview{gap:11px;grid-template-columns:.85fr .95fr 1.45fr 1.16fr .62fr}.stage-head>span{font-size:11px}}
