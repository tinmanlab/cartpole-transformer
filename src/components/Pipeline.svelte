...
.stage-head{display:grid;grid-template-columns:22px 1fr;column-gap:7px;align-items:center;margin-bottom:9px;text-align:left}.stage-head>b{grid-row:1/3;width:22px;height:22px;line-height:22px;border-radius:50%;background:#293548;color:#fff;font-size:10px;text-align:center}.stage-head>span{font-size:12px;font-weight:700;color:#4b5563}.stage-head>small{font-size:10px;color:#9299a5}
...
.force-visual{font-size:48px;color:#8b5cf6;line-height:.85}.force-value{display:block;font:12px ui-monospace,SFMono-Regular,Menlo,monospace;color:#6d52aa;margin-top:8px}.action-overview>small{font-size:10px;color:#9299a5}
