...
<style>
.fusion-pipeline{height:500px;background:#fff;border:1px solid #e2e5ea;border-radius:16px;padding:12px;display:flex;flex-direction:column;overflow:hidden}
.panel-head{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:0 3px 8px;border-bottom:1px solid #edf0f3}.panel-head>div{display:flex;flex-direction:column}.panel-head strong{font-size:14px}.panel-head small{font-size:9px;color:#8a93a2}.panel-head>span{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7257b5}
.scenario-bar{display:flex;gap:4px;padding:8px 2px 0;flex-wrap:wrap}.scenario-bar button{border:1px solid #dfe3e8;background:#fff;border-radius:6px;padding:4px 7px;font-size:8px;color:#6f7886;cursor:pointer}.scenario-bar button.active{background:#efeaf8;border-color:#a895cf;color:#604b95}
...
.stage-head{display:grid;grid-template-columns:22px 1fr;column-gap:7px;align-items:center;margin-bottom:8px;text-align:left}.stage-head>b{grid-row:1/3;width:22px;height:22px;line-height:22px;border-radius:50%;background:#293548;color:#fff;font-size:10px;text-align:center}.stage-head>span{font-size:11px;font-weight:700;color:#4b5563}.stage-head>small{font-size:8px;color:#9299a5}
.pair-stack{display:flex;flex-direction:column;gap:4px}.pair{display:flex;align-items:center;justify-content:center;gap:5px;padding:3px;border-radius:5px}.pair.selected{background:#f1eef9}.pair .time{width:36px;text-align:right;font:7px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7b8492}.pair-values{display:flex;gap:3px}.state-chip,.vision-chip{width:22px;height:18px;line-height:18px;border-radius:4px;text-align:center;font-size:8px;font-weight:700}.state-chip{background:#e7efff;color:#3c67b2}.vision-chip{background:#e7f7ef;color:#30805a}.state-chip.off,.vision-chip.off{opacity:.2;text-decoration:line-through}.vision-chip.partial{background:linear-gradient(90deg,#e7f7ef 50%,#f0f1f3 50%)}
.token-stack{display:grid;grid-template-columns:1fr 1fr;gap:3px}.token{display:flex;align-items:center;justify-content:center;gap:4px;padding:2px;border-radius:4px}.token.selected{background:#f1eef9}.token>span{width:34px;font:7px ui-monospace,SFMono-Regular,Menlo,monospace;color:#687386}.token-vector{position:relative;width:20px;height:28px;border:1px solid #e0e4e9;border-radius:3px;overflow:hidden}
.matrix-wrap{display:flex;justify-content:center;padding:7px;border:1px solid #e4e7ec;border-radius:8px;background:#fbfbfd}.cross-read{display:grid;grid-template-columns:1fr auto;gap:3px 8px;margin-top:7px;font-size:8px;color:#717a88}.cross-read b{font:9px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7059aa}
.output-grid{display:grid;grid-template-columns:1fr 1fr;gap:5px}.output-grid>div{padding:6px;border:1px solid #e3e6eb;border-radius:6px;background:#fafbfc}.output-grid span{display:block;font-size:7px;color:#88919e}.output-grid b{font:9px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}.force{margin-top:8px;padding:8px;border-radius:7px;background:#f1eef9;font:12px ui-monospace,SFMono-Regular,Menlo,monospace;color:#674e9f}
@media(max-width:980px){.fusion-pipeline{height:auto;overflow:visible}.fusion-pipeline .upstream-sankey{display:none!important}.fusion-overview{display:flex;flex-direction:column;gap:18px}.stage{width:100%;max-width:520px;border:1px solid #edf0f3;border-radius:10px;padding:10px}.stage:not(:last-child)::after{content:'↓';display:block;margin:8px auto -16px;color:#8b5cf6;font-size:18px}.token-stack{grid-template-columns:repeat(4,1fr)}}
</style>
