...
.matrix-wrap{display:flex;justify-content:center;padding:7px;border:1px solid #e4e7ec;border-radius:8px;background:#fbfbfd}.cross-read{display:grid;grid-template-columns:1fr auto;gap:4px 8px;margin-top:7px;font-size:10px;color:#717a88}.cross-read b{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7059aa}
