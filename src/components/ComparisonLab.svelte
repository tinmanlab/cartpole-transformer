...
.compare-head{display:flex;justify-content:space-between;gap:18px;align-items:flex-start;padding-bottom:11px;border-bottom:1px solid #edf0f3}.eyebrow{font-size:10px;letter-spacing:.08em;color:#7f70aa}.compare-head h2{font-size:18px;margin:2px 0 3px}.compare-head p{font-size:10px;color:#717a88;margin:0}.compare-clock{text-align:right;min-width:78px}.compare-clock b{display:block;white-space:nowrap;font:18px ui-monospace,SFMono-Regular,Menlo,monospace}.compare-clock span{font-size:10px;color:#8b93a1}
.shared-disturbance{display:grid;grid-template-columns:130px 1fr;gap:12px;align-items:center;margin:11px 0}.disturbance-now span{display:block;font-size:10px;color:#7f8896}.disturbance-now b{font:11px ui-monospace,SFMono-Regular,Menlo,monospace;color:#667085}.disturbance-now b.active{color:#b86713}.timeline{height:12px;border-radius:6px;background:#edf0f3;position:relative;overflow:hidden}.timeline i{position:absolute;top:0;bottom:0;background:#d7a05b}.timeline i.negative{background:#7da2cc}.timeline em{position:absolute;top:-2px;bottom:-2px;width:2px;background:#5d4b92;z-index:2}
.controller-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px}.controller-card{border:1px solid #e3e7ed;border-radius:11px;padding:10px;background:#fbfcfd}.controller-card.failed{background:#f5f5f6}.controller-head{display:flex;justify-content:space-between;align-items:flex-start}.controller-head>div{display:flex;flex-direction:column}.controller-head b{font-size:13px}.controller-head span{font-size:10px;color:#7f8896}.controller-head strong{font-size:10px;color:#3d8a64}.controller-card.failed .controller-head strong{color:#b65c5c}.mini-sim{width:100%;height:180px;display:block;margin-top:5px;background:linear-gradient(#fff,#f7f8fa);border-radius:8px;border:1px solid #edf0f3}
.live-values,.metrics{display:grid;grid-template-columns:1fr 1fr;gap:4px;margin-top:7px}.live-values>div,.metrics>div{padding:5px 6px;border:1px solid #e6e9ed;border-radius:6px;background:#fff}.live-values span,.metrics span{display:block;font-size:10px;color:#7f8896}.live-values b,.metrics b{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}
.replay-controls{display:grid;grid-template-columns:auto auto auto auto minmax(160px,1fr) auto;gap:7px;align-items:center;margin-top:11px}.replay-controls button{border:1px solid #d9dde5;border-radius:7px;background:#fff;padding:6px 9px;min-height:30px;font-size:10px;cursor:pointer}.replay-controls .primary{background:#293548;color:#fff;border-color:#293548}.replay-controls button:disabled{opacity:.35}.replay-controls span{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#78818f}.replay-controls input{width:100%}
.final-summary{margin-top:9px;padding:8px 10px;border-radius:7px;background:#f3f0f9;display:flex;gap:10px;align-items:baseline}.final-summary b{font-size:10px;color:#5f4a93}.final-summary span{font-size:10px;color:#707887}
