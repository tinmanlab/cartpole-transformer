  ...
  <div class="vision-flow">
    ...
    <article>
      ...
      <div class="detail-patch-pair">
        <div>
          <b>frame patches</b>
          <VisionPatchGrid {patches} {gridSize} patchSize={2} cellSize={8}
...
.detail-patch-pair{display:flex;flex-direction:column;gap:10px;align-items:center}.detail-patch-pair>div{display:flex;flex-direction:column;align-items:center;gap:4px}.detail-patch-pair b{font-size:8px;color:#687386}.patch-read{font:9px ui-monospace,SFMono-Regular,Menlo,monospace;color:#667085}
