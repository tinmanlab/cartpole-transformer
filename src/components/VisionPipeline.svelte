...
<section class="vision-pipeline resize-watch">
  ...
  <div class="vision-overview resize-watch">
    ...
    <button class="stage vision-stage-token" type="button" on:click={onOpenDetail}>
      <div class="stage-head"><b>3</b><span>Frame tokens</span><small>concat 512D → 24D + time</small></div>
...
<style>
.vision-pipeline{height:auto;min-height:500px;background:#fff;border:1px solid #e2e5ea;border-radius:16px;padding:12px;display:flex;flex-direction:column;overflow:hidden}
...
.stage-head{display:grid;grid-template-columns:22px 1fr;column-gap:7px;align-items:center;margin-bottom:9px;text-align:left}.stage-head>b{grid-row:1/3;width:22px;height:22px;line-height:22px;border-radius:50%;background:#293548;color:#fff;font-size:10px;text-align:center}.stage-head>span{font-size:11px;font-weight:700;color:#4b5563}.stage-head>small{font-size:10px;color:#9299a5}
...
.patch-pair{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px}.patch-pair>div{display:flex;flex-direction:column;align-items:center;gap:2px}.patch-pair>div>span{font-size:10px;color:#7b8492}.patch-pair :global(.caption),.patch-pair :global(.axis){display:none}
.token-stack{display:flex;flex-direction:column;gap:3px}.frame-token{display:flex;align-items:center;justify-content:center;gap:5px;padding:2px;border-radius:5px}.frame-token.selected{background:#eef3fb}.frame-token>span{width:29px;text-align:right;font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7b8492}.token-vector{position:relative;width:24px;height:29px;border:1px solid #dfe3e8;border-radius:4px;overflow:hidden}
.matrix-wrap{display:flex;justify-content:center;padding:8px;border:1px solid #e4e7ec;border-radius:9px;background:#fbfbfd}.latest-weight{text-align:center;margin-top:7px;font-size:10px;color:#6f7886}.latest-weight b{color:#7257b5}
.output{display:flex;flex-direction:column;gap:8px}.output>div{padding:7px;border:1px solid #e4e7ec;border-radius:7px;background:#fafbfc}.output span{display:block;font-size:10px;color:#7b8492}.output b{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}.output .force{background:#f3f0fa}.output strong{font:12px ui-monospace,SFMono-Regular,Menlo,monospace;color:#674e9f}
