...
.patch-pair{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:4px}.patch-pair>div{display:flex;flex-direction:column;align-items:center;gap:2px}.patch-pair>div>span{font-size:7px;color:#7b8492}.patch-pair :global(.caption),.patch-pair :global(.axis){display:none}
