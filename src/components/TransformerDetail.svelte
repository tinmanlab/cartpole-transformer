...
@media(max-width:980px){.transformer-detail-wide{padding:15px 14px}.qkv-detail{grid-template-columns:1fr 1fr;min-width:720px}.source-token{grid-row:1/3}.attention-wide,.block-detail,.action-detail,.calc-line{overflow-x:auto}.detail-head h2{font-size:18px}}
</style>
