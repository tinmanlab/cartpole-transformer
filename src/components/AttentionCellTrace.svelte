...
.trace-head{display:flex;justify-content:space-between;gap:20px;align-items:flex-start;margin-bottom:14px}.eyebrow{font-size:9px;letter-spacing:.08em;color:#8170ae}.trace-head h3{font-size:17px;margin:2px 0 3px}.trace-head p{margin:0;font-size:11px;color:#6d7684}.weight-badge{min-width:126px;padding:9px 12px;border-radius:9px;background:#f2eff9;text-align:right}.weight-badge small{display:block;font-size:8px;color:#806cae}.weight-badge strong{font:17px ui-monospace,SFMono-Regular,Menlo,monospace;color:#674e9f}.weight-badge.masked{background:#f4f5f7}.weight-badge.masked strong{color:#7b8492}
.selector-row{display:grid;grid-template-columns:auto 1fr auto 1fr;gap:7px 10px;align-items:center;margin-bottom:18px}.selector-row>span{font-size:9px;font-weight:700;color:#687386}.selector-buttons{display:flex;gap:4px;flex-wrap:wrap}.selector-buttons button,.softmax-row button{border:1px solid #dfe3e8;background:#fff;border-radius:6px;min-height:30px;padding:4px 7px;font-size:8px;color:#667085;cursor:pointer}.selector-buttons button.active,.softmax-row button.active{background:#ece7f7;border-color:#a895cf;color:#5e4894}.selector-buttons button.future{border-style:dashed;color:#a0a6b0}
.trace-flow{display:flex;align-items:stretch;gap:9px;min-width:1260px}.trace-stage{position:relative;flex:1;min-width:0;padding:12px;border:1px solid #e3e7ed;border-radius:10px;background:#fbfcfd}.trace-stage h4{font-size:11px;margin:0 0 10px;color:#505a69}.step{position:absolute;top:8px;right:8px;width:19px;height:19px;border-radius:50%;background:#293548;color:#fff;text-align:center;line-height:19px;font-size:8px;font-weight:700}.trace-arrow{display:flex;align-items:center;color:#826db7;font-size:18px}
.qk-stage{flex:1.5}.qk-vectors,.value-flow{display:flex;align-items:center;justify-content:center;gap:8px}.qk-vectors>div,.value-flow>div{display:flex;flex-direction:column;align-items:center;gap:4px}.qk-vectors b,.value-flow b{font-size:8px;color:#667085}.trace-vector{position:relative;width:25px;height:72px;border:1px solid #dde2e8;border-radius:4px;overflow:hidden;background:#fff}.trace-vector.contribution,.trace-vector.context{outline:2px solid #ded6f1}.product-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:4px;margin-top:10px}.product-grid>div{padding:5px;border-radius:5px;background:#fff;border:1px solid #e8eaee}.product-grid small{display:block;font-size:6px;color:#9299a5}.product-grid code{display:block;font-size:6.5px;color:#697386;white-space:nowrap}.product-grid b{font:8px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}.product-matrix{display:flex;justify-content:center;margin-top:8px}
.equation{display:grid;grid-template-columns:1fr auto;gap:6px 10px;align-items:baseline}.equation span{font-size:8px;color:#7b8492}.equation strong{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}.score-stage p{font-size:8px;line-height:1.4;color:#7b8492;margin:10px 0 0}.mask-stage.masked{background:#f7f7f8}.masked-block,.pass-block{display:flex;flex-direction:column;gap:7px}.masked-block strong,.pass-block strong{font-size:9px;color:#596273}.masked-block code,.pass-block code{font-size:9px}.masked-block span{font-size:8px;color:#7b8492}
.softmax-stage{flex:1.25}.softmax-row{display:grid;grid-template-columns:repeat(4,1fr);gap:3px;margin-top:10px}.softmax-row button{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:3px}.softmax-row button span{font-size:6px}.softmax-row button b{font-size:8px}
.value-stage{flex:1.7}.value-flow>span{font-size:7px;color:#7d8593;white-space:nowrap}.numeric-row{display:flex;flex-direction:column;gap:3px;margin-top:10px}.numeric-row code{font-size:6.5px;color:#667085;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
@media(max-width:980px){.attention-cell-trace{overflow-x:auto}.selector-row{grid-template-columns:auto 1fr}.trace-flow{min-width:1200px}.trace-head{min-width:700px}}
</style>
