...
.qk-stage{flex:1.5}.qk-vectors,.value-flow{display:flex;align-items:center;justify-content:center;gap:8px}.qk-vectors>div,.value-flow>div{display:flex;flex-direction:column;align-items:center;gap:4px}.qk-vectors b,.value-flow b{font-size:10px;color:#667085}.trace-vector{position:relative;width:25px;height:72px;border:1px solid #dde2e8;border-radius:4px;overflow:hidden;background:#fff}.trace-vector.contribution,.trace-vector.context{outline:2px solid #ded6f1}.product-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:4px;margin-top:10px}.product-grid .product-dim{appearance:none;font:inherit;text-align:left;padding:5px;border-radius:5px;background:#fff;border:1px solid #e8eaee;cursor:pointer}.product-grid .product-dim.selected{border-color:#a895cf;background:#f2eff9}.product-grid small{display:block;font-size:10px;color:#9299a5}.product-grid code{display:block;font-size:10px;color:#697386;white-space:nowrap}.product-grid b{font:11px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}.product-matrix{display:flex;justify-content:center;margin-top:8px}
