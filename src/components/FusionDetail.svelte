...
<style>
.fusion-detail-wide{margin-top:10px;background:#fff;border:1px solid #e1e5ea;border-radius:16px;padding:18px 22px 22px;min-width:0}
...
.scenario-bar{display:flex;gap:5px;flex-wrap:wrap;padding:12px 0}.scenario-bar button{border:1px solid #dfe3e8;background:#fff;border-radius:6px;padding:6px 9px;min-height:30px;font-size:10px;color:#687386;cursor:pointer}.scenario-bar button.active{background:#efeaf8;border-color:#a895cf;color:#604b95}
.token-pairs{display:grid;grid-template-columns:repeat(8,1fr);gap:6px;padding:4px 0 16px}.time-pair{display:flex;flex-direction:column;align-items:center;gap:4px}.time-pair>.time{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#7b8492}.time-pair button{display:flex;align-items:center;gap:4px;border:1px solid #e2e5ea;background:#fff;border-radius:6px;padding:4px;cursor:pointer}.time-pair button.active{background:#f1eef9;border-color:#aa9ad0}.time-pair b{font-size:10px;color:#687386}.vec{position:relative;width:18px;height:34px;border:1px solid #e0e3e8;border-radius:3px;overflow:hidden}
.fusion-grid{display:grid;grid-template-columns:1.25fr 1fr .8fr;gap:12px}.fusion-grid article{border:1px solid #e3e7ed;border-radius:10px;background:#fbfcfd;padding:14px;min-width:0}.fusion-grid h3,.ablation h3{font-size:12px;margin:0 0 10px;color:#505a69}
/* The 16x16 attention matrix doesn't shrink below its cell grid; scroll it
   locally instead of clipping cells (overflow:hidden) or forcing the whole page wider */
.matrix{display:flex;justify-content:flex-start;overflow-x:auto;max-width:100%}
.legend{margin-top:8px;font-size:10px;color:#737d8b;text-align:center}.legend .s{color:#3c67b2;font-weight:800}.legend .v{color:#30805a;font-weight:800;margin-left:8px}
.bars{display:flex;flex-direction:column;gap:8px}.bars>div{position:relative;display:grid;grid-template-columns:1fr auto;gap:6px;padding-bottom:5px;border-bottom:3px solid #eceef2}.bars span{font-size:10px;color:#687386}.bars b{font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#604b95}.bars i{position:absolute;left:0;bottom:-3px;height:3px;background:#9d89c9;max-width:100%}.same-time{margin-top:10px;font-size:10px;color:#737d8b}.same-time b{color:#604b95}
.state-grid{display:grid;grid-template-columns:1fr 1fr;gap:6px}.state-grid>div{padding:8px;border:1px solid #e3e6eb;border-radius:7px;background:#fff}.state-grid span,.state-grid small{display:block;font-size:10px;color:#7b8492}.state-grid b{display:block;font:10px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563;margin:2px 0}
.ablation{margin-top:14px;padding:14px;border:1px solid #e3e7ed;border-radius:10px;background:#fcfcfd}.ablation-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:6px}.ablation-grid>div{padding:8px;border-radius:7px;background:#f7f8fa;border:1px solid #e6e9ed}.ablation-grid span{display:block;font-size:10px;color:#6d7684}.ablation-grid b{font:12px ui-monospace,SFMono-Regular,Menlo,monospace;color:#4b5563}.ablation-grid .positive{background:#eff8f3}.ablation-grid .negative{background:#fff6ed}.ablation p{font-size:10px;line-height:1.5;color:#667085;margin:10px 0 0}
